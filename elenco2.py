...
# def isViable(group_binary, x, n_character):
#     print('sum', sum(group_binary) == len(group_binary))
#     print('len', len(x) == n_character)
#     print(group_binary, x, n_character)
#     return (sum(group_binary) == len(group_binary)) and (len(x) == n_character) 
...
# def branch(cast, level, n_character, n_actor, actor, n_group):
...
#         #if checkGroups(cast, actor, n_group):
#         if allgroups:
#             #print('Solução viável {} no level {}'.format(cast, level))
...
#         aux.append(0)
#         n_nodes+=1
#         branch(aux, level + 1, n_character, n_actor, actor, n_group) 
...
#     len_actor = len(actor)
#     len_cast = len(cast)
#     if level < n_character: 
#         if len_cast > 0:
#             x = actor[len_cast:len_actor - n_character - sum_cast]
#         else:
#             x = actor[:len_actor - 1 - n_character]
#         sum_x = sum([i.cost for i in x])
#         return cast_cost + sum_x
#     return cast_cost
...
def branch1(cast, level, n_character, n_actor, actor, n_group):
    ...
    if isViable(cast, n_character):
        ...
        return
    # print('nivel {} e optv {}'.format(level,optV))
    # b2 = bound2(actor, n_character, cast)
    # 1
    bound = bound1(actor, n_character, cast)
    aux = cast[:]
    if len(aux) < n_actor and bound < optV:
...
#---------------------------------------------------------------------------------
# Função de branch  faz a verificação pelo custo do cast na mão
#--------------------------------------------------------------------------------
# def branch2(cast, level, n_character, n_actor, actor, n_group):
...
#     # 1
#     #print('Cast ', cast)
#     bound = bound2(actor, n_character, cast)
#     aux = cast[:]
#     if len(aux) < n_actor and bound < optV:
#         aux.append(1)
#         n_nodes+=1
#         branch2(aux, level + 1, n_character, n_actor, actor, n_group) 
